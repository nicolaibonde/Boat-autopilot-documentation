...
Boost test and FakeIt \cite{fakeit} were chosen as the test frameworks, for more information on this, see the section~\ref{sec:unit_test} on page~\pageref{sec:unit_test} of this report.