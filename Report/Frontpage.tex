...
\selectlanguage{danish}
	...
	\begin{center}
			...
			\begin{minipage}{0.40\linewidth}
				\centering
				\includegraphics[height = 50pt]{../Appendix/Project/Dokumentation/Images/Signatures/nicolai1}			
				\hrule
				\vspace{12pt}
			...
			\begin{minipage}{0.40\linewidth}
				\centering
				\includegraphics[height = 50pt]{../Appendix/Project/Dokumentation/Images/Signatures/troels1}	
				\hrule
				\vspace{12pt}
