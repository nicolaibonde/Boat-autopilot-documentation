...
The controller chosen for the system is the Raspberry Pi model 3b, and the GPS receiver a Ublox Neo 7-M-0-000. The motor controller is a Cytron MD30C rev. 2 \cite{md30}, and the stepdown circuits used for the servo and controller are LM2596's \cite{stepdown} which were available at the engineering school's Embedded Stock. The logic level shifter was likewise found in Embedded Stock.
